...
Headline (visible answer tokens as % of vanilla): **coding** — rdxmin 14%,
ponytail 29%, caveman 46%. **non-coding** — caveman 79%, rdxmin 96%, ponytail
121%. Full writeup: [`results/2026-06-29-live-4arm.md`](./results/2026-06-29-live-4arm.md).

rdxmin is leanest on code; on pure prose a dedicated prose compressor wins. The
...
arms — baseline (no plugin), rdxmin, and (optionally) the parent-style
